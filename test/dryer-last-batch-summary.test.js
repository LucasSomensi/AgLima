...
test('dryer completed batch history renders batches from newest to oldest with the same summary fields', () => {
  ...
  assert.match(html, /Batelada 1[\s\S]*13\/06\/2026, 07:00[\s\S]*Tempo secando<\/dt>\s*<dd>2h<\/dd>[\s\S]*Tempo descarga<\/dt>\s*<dd>1h 15min<\/dd>[\s\S]*Batelada 2[\s\S]*12\/06\/2026, 07:00/);
});
